...
export default {
  ...
  methods: {
    ...
    getTickerData() {
      ...
      const res = instance.get(`https://www.fireant.vn/api/Data/Companies/HistoricalQuotes?symbol=${this.ticker}&startDate=2021-12-12&endDate=2022-1-12`,{
    ...
    'Cookie': 'ASP.NET_SessionId=luubf2lplsuqig5pbmv0s1ib; _ga=GA1.2.849319539.1641982875; _gid=GA1.2.430608104.1641982875; _gat=1'
      ...
      }).then((response) => {this.tickerData=response.data
      });
